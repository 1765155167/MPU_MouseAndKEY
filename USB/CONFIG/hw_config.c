...
void Joystick_Send_mouse(u8 buf0,u8 buf1,u8 buf2,u8 buf3)
{
...
void Joystick_Send_key(u8 buf0,u8 buf1,u8 buf2,u8 buf3,u8 buf4,u8 buf5,u8 buf6,u8 buf7)
{
  u8 KeyBoard_Buffer[9] = {0, 0, 0, 0, 0, 0, 0, 0};
    
  /* prepare buffer to send */

  KeyBoard_Buffer[0]=0;
  KeyBoard_Buffer[1]=buf0;
	KeyBoard_Buffer[2]=buf1;
	KeyBoard_Buffer[3]=buf2;
	KeyBoard_Buffer[4]=buf3;
  KeyBoard_Buffer[5]=buf4;
	KeyBoard_Buffer[6]=buf5;
	KeyBoard_Buffer[7]=buf6;
	KeyBoard_Buffer[8]=buf7;
  /*copy mouse position info in ENDP1 Tx Packet Memory Area*/
